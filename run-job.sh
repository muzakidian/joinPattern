# Variabel-variabel
FILE_JAR=target/joinPattern-1.0-SNAPSHOT.jar
HADOOP_USERNAME=hadoopuser
IP_NAMENODE=192.168.0.25
HOME_DIR=/home/hadoopuser/
NAMA_JAR_TUJUAN=joinPattern.jar
PACKAGE_ID=org.example.App
INPUT_FOLDER_CITY=/muzakidian/Join/City
INPUT_FOLDER_TEMPERATURE=/muzakidian/Join/Temperature
OUTPUT_FOLDER=/muzakidian/Join/Hasil
